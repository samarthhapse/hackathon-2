...
class Generator:
    ...
    def generate(self,):
        ...
        # response=requests.post(url='https://mernecomerce.onrender.com',data=json.dumps(request))
        response=requests.post(url='https://backend:8080/predict/',data=json.dumps(request))
        return response